...
E0 = 70e3
nu = 0.3
batch_sizes = [1, 10, 20, 40, 80, 100, 120]
...
def single_solve(traction_magnitude):
    ...
    traction_z = fe.internal_vars.InternalVars.create_uniform_surface_var(problem, traction_magnitude)
...
fig_path = os.path.join(data_dir, 'vmap_comparison.png')
